...
public class SqlGenerator {
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "/Users/dxz/IdeaProjects/github/SpringBoot0/SpringBoot+Restful/src/main/java/com/example/demo/bean/";
        //生成sql的文件夹
        String filePath = "/Users/dxz/Desktop/";
        //项目中实体类的路径
        String prefix = "com.example.demo.bean.";
        String className = "";
    ...
    public static String generateSql(String className, String filePath) {
        try {
            ...
            className = getStandardFields(className).toLowerCase();
